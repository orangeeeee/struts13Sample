...
(function(window, document, undefined) {
	...
	GridProto.addSelectionColumn = function(data) {
		...
		if (this.options.showSelectionColumn) {
			...
			this.options.colBGColors.unshift(this.options.colBGColors[1] || "");
			this.options.colBGColors.unshift(this.options.colBGColors[2] || "");
			this.options.colBGColors.unshift(this.options.colBGColors[3] || "");
			this.options.colBGColors.unshift(this.options.colBGColors[4] || "");
			this.options.colBGColors.unshift(this.options.colBGColors[5] || "");
			this.options.colBGColors.unshift(this.options.colBGColors[6] || "");
			this.options.colBGColors.unshift(this.options.colBGColors[7] || "");
			this.options.colBGColors.unshift(this.options.colBGColors[8] || "");
			this.options.colBGColors.unshift(this.options.colBGColors[9] || "");
			this.options.colBGColors.unshift(this.options.colBGColors[10] || "");
			this.options.colBGColors.unshift(this.options.colBGColors[11] || "");
			this.options.colBGColors.unshift(this.options.colBGColors[12] || "");
																										/*
	...
	GridProto.displayGrid = function() {
		...
		//this.alignTimer = window.setTimeout(bind(this.alignColumns, this, false, true), 16);
																								this.alignTimer = window.setTimeout(bind(this.alignColumns, this, false, true), 34);
	};
